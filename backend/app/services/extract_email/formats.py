...
_FORMATS: list[FormatSpec] = [
    FormatSpec(
        ...
        markers=[
            ...
            (_pat(r"\bHours\s+Worked\b"), 1),
            (_pat(r"\bDAILY\s+TOTAL\b"), 1),
    ...
    FormatSpec(
        ...
        markers=[
            (_pat(r"\bADNOC\b"), 3),
            (_pat(r"\bTIMESHEET\b"), 2),
            (_pat(r"Service\s+Provider"), 3),
            (_pat(r"\bOvertime\b"), 1),
    ...
    FormatSpec(
        ...
        label="Gov Employee Daily Report (DMT / FDF)",
        markers=[
